...
def simulate_income_distribution_disabled(N, p_e, s_e, h_e0, delta_e, delta, sigma_psi,
    ...
    for t, age in enumerate(ages):
        ...
        #Indviduals are either in labor market or not employed due to school or disability
        labor = (~in_school) & (~disabled)
